...
static void printHelp(void)
{
	...
	clog << "\n\nExamples:\n"
		<< "pinot-search opensearch " << PINOT_PREFIX << "/share/pinot/engines/KrustyDescription.xml \"clowns\"\n\n"
		<< "pinot-search --max 20 sherlock " << PINOT_PREFIX << "/share/pinot/engines/Bozo.src \"clowns\"\n\n"
