...
private:
	...
	Gtk::VBox *enginesVbox;
	Gtk::Button *addIndexButton;
	Gtk::Button *removeIndexButton;
	Gtk::VBox *leftVbox;
	Gtk::ToggleButton *enginesTogglebutton;
	Gtk::Entry *liveQueryEntry;
	Gtk::Button *findButton;
	Gtk::TreeView *queryTreeview;
	Gtk::Button *addQueryButton;
	Gtk::Button *removeQueryButton;
	Gtk::Button *queryHistoryButton;
	Gtk::Button *findQueryButton;
	Gtk::Expander *queryExpander;
	Gtk::VBox *rightVbox;
	Gtk::HPaned *mainHpaned;
	Gtk::HBox *mainHbox;
	Gtk::ProgressBar *mainProgressbar;
